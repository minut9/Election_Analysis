...
file_to_load = os.path.join("/Users/joseph/Desktop/Resources/analysis/election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join("/Users/joseph/Desktop/Resources/analysis/election_analysis .txt")
